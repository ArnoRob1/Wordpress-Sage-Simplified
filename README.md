# Sage simplified
This is my personnal implementation of SAGE, the very good WordPress Starter theme. Thanks roots for your work !
What I did :
* take bootstrap out of bower to accelerate Gulp processing
* removed customizer.php...

Some informations :
* Even if bower file is empty, you still have to run bower install...
* secrets.json is used in the gulp file, and with wpdbclone.js
